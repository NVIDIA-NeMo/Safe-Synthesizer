...
AI-agent guide for the Safe-Synthesizer test suite.

Full testing documentation -- commands, markers, data locations, fixtures, mocking conventions, and gotchas: [TESTING.md](TESTING.md).
