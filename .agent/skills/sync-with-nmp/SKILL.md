...
For step-by-step recipes covering end-to-end scenarios (e.g., syncing multiple MRs, verifying NMP MR before syncing, full release sync), see [workflows.md](workflows.md).
