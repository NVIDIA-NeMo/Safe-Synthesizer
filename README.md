...
NeMo Safe Synthesizer includes an optional function to share anonymous run-level telemetry data with NVIDIA for product improvement. See the [Telemetry & Privacy docs](https://nvidia-nemo.github.io/Safe-Synthesizer/latest/#telemetry--privacy) for details about what is collected, how telemetry is used, and how to opt out.

To disable telemetry in a YAML config, set:
