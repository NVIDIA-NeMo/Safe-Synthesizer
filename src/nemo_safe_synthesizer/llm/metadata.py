...
class ModelMetadata(BaseModel):
    ...
    avg_records_per_example: float | None = Field(
        default=None, description="Mean records per training example, computed during training for prefill sizing."
    )

    avg_tokens_per_record: float | None = Field(
        default=None, description="Mean tokens per record, computed during training for context budget estimation."
    )
