...
tooltips = {
    "dataset_statistics_info": """
        ...
        the percentage of missing values in the datasets, and the number of lines from the training data that are repeated verbatim in the synthetic data.
    """,
    "sqs_info": """
    ...
    "column_correlation_stability_info": """
        ...
        and then in the synthetic data. The absolute difference between these values is then computed and averaged across all columns.
        The lower this average value is, the higher the Column Correlation Stability quality score will be.
        To aid in the comparison of correlations, a heatmap is shown for both the training data and the synthetic data,
        as well as a heatmap for the computed difference of correlation values. If the intended purpose of the synthetic data is to
    ...
    "deep_structure_stability_info": """
        Deep Structure Stability is a measure of how well the synthetic data matches the training data in terms of the structure of the data.
        ...
        embeddings of the numeric and categorical columns in the training and synthetic data.
    """,
    "column_distribution_stability_info": """
        Column Distribution Stability is a measure of how closely the column distributions in the synthetic data mirror those in the training data.
    ...
    "data_privacy_score_info": """
        The Data Privacy Score (DPS) is a measure of how well the synthetic data protects sensitive information present in the training data.
    ...
    """,
    "pii_replay_info": """
        PII Replay counts the number of total and unique instances of personally identifiable information (PII) from your training data that show up in your synthetic data.
        Lower counts under "Synthetic Data PII Replay" indicate higher privacy. Note that some PII replay is often expected (and even desirable).<br>
    ...
    "membership_inference_info": """
        ...
        to determine whether a particular data sample was part of the model's synthetic dataset. By exploiting the differences
        ...
        specific individuals' data was used to train the model. Based on directly analyzing the synthetic data, a high
        score indicates that your synthetic data is well-protected from this type of attack.
    """,
    "attribute_inference_info": """
        ...
        were not intended to be revealed by the data owners. Based on directly analyzing the synthetic data, a high
        score indicates that your synthetic data is well-protected from this type of attack.
    """,
}
