...
from .preview import PiiPlanPreview, build_plan_preview
...
class TabularPiiReplacer:
    ...
    def preview_plan(
        ...
        *,
        ...
        """Resolve and preview the PII plan without applying replacements.

        The returned object displays as HTML in notebooks and retains a plain-text
        fallback for other environments. Sample values always come from ``df``;
        no synthetic values are generated by this method.
        ...
        Returns:
            A notebook-renderable resolved-plan preview.
        ...
        self.resolved_plan = preview.plan
        return preview
