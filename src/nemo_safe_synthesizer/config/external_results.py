...
class SafeSynthesizerSummary(NSSBaseModel):
    ...
    num_valid_record_tokens: int | None = Field(
        default=None, description="Tokens in records that passed validation."
    )

    num_invalid_record_tokens: int | None = Field(
        default=None, description="Tokens in records that failed validation."
    )

    num_non_record_tokens: int | None = Field(
        default=None, description="Tokens not part of any recognized record."
    )
    ...
    tokens_per_completion: float | None = Field(
        default=None, description="Average tokens per LLM completion."
    )
    ...
    def log_wandb(self) -> None:
        ...
        if wandb.run is not None:
            metrics: dict[str, float | int | None] = {
                ...
                "gen/tokens_per_completion": self.tokens_per_completion,
