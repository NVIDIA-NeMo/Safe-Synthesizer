...
def make_nss_summary(
    ...
    if report is not None:
        ...
        time_series_similarity_score = report.get_score_by_name("Time Series Similarity Score")
        autocorrelation_similarity_score = report.get_score_by_name("Autocorrelation Similarity")
        drift_similarity_score = report.get_score_by_name("Drift Similarity")
        hurst_similarity_score = report.get_score_by_name("Hurst Similarity")
        dtw_similarity_score = report.get_score_by_name("DTW Similarity")
        rolling_stats_similarity_score = report.get_score_by_name("Rolling Stats Similarity")
        spectral_similarity_score = report.get_score_by_name("Spectral Similarity")
        adf_stationarity_score = report.get_score_by_name("ADF Stationarity")
        tsc_utility_score = report.get_score_by_name("Time Series Classification Utility")
        ...
        time_series_similarity_score = None
        autocorrelation_similarity_score = None
        drift_similarity_score = None
        hurst_similarity_score = None
        dtw_similarity_score = None
        rolling_stats_similarity_score = None
        spectral_similarity_score = None
        adf_stationarity_score = None
        tsc_utility_score = None
    ...
    return SafeSynthesizerSummary(
        ...
        time_series_similarity_score=time_series_similarity_score,
        autocorrelation_similarity_score=autocorrelation_similarity_score,
        drift_similarity_score=drift_similarity_score,
        hurst_similarity_score=hurst_similarity_score,
        dtw_similarity_score=dtw_similarity_score,
        rolling_stats_similarity_score=rolling_stats_similarity_score,
        spectral_similarity_score=spectral_similarity_score,
        adf_stationarity_score=adf_stationarity_score,
        tsc_utility_score=tsc_utility_score,
